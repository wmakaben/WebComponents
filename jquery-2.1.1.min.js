...
function(a, b) {
            ...
            if (l && (c = n.buildFragment(a, this[0].ownerDocument, !
                ...
                if (g)
                    for (i = f[f.length - 1].ownerDocument, n.map(
                            f, lb), j = 0; g > j; j++) h = f[j],
                        fb.test(h.type || "") && !L.access(h,
    ...
    function Hb(a, b, c, d, e) {
        for (var f = c === (d ? "border" : "content") ? 4 : "width" ===
                b ? 1 : 0, g = 0; 4 > f; f += 2) "margin" === c && (g +=
            n.css(a, c + R[f], !0, e)), d ? ("content" === c && (g -=
                n.css(a, "padding" + R[f], !0, e)), "margin" !== c &&
            (g -= n.css(a, "border" + R[f] + "Width", !0, e))) : (g +=
            n.css(a, "padding" + R[f], !0, e), "padding" !== c && (
        ...
        var d, e, f = 0,
            ...
            i = function() {
                ...
                for (var b = Lb || Sb(), c = Math.max(0, j.startTime +
                        ...
                        1 - d, g = 0, i = j.tweens.length; i > g; g++) j
                    .tweens[g].run(f);
    ...
    n.extend({
        ...
        ajaxSetup: function(a, b) {
            return b ? tc(tc(a, n.ajaxSettings), b) : tc(n.ajaxSettings,
                a)
        },
        ajaxPrefilter: rc(nc),
        ajaxTransport: rc(oc),
        ajax: function(a, b) {
            ...
            i = k.global, i && 0 === n.active++ && n.event.trigger(
    ...
    a.ActiveXObject && n(a).on("unload", function() {
        ...
        }), k.cors = !!Fc && "withCredentials" in Fc, k.ajax = Fc = !!Fc, n
    ...
    n.offset = {
            ...
            n.cssHooks[b] = yb(k.pixelPosition, function(a, c) {
                return c ? (c = xb(a, b), vb.test(c) ? n(a).position()[
                    b] + "px" : c) : void 0
            })
        }), n.each({
            Height: "height",
    ...
    return n.noConflict = function(b) {
        return a.$ === n && (a.$ = Mc), b && a.jQuery === n && (a.jQuery =
            Lc), n
